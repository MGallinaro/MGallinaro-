  ...
  var pages = {
    ...
    'pubblicazioni.html': {
      ...
      '.entry:first-child > span:last-child': { it: 'Best Paper Award — <span class="venue">IEEE International Workshop on Metrology for Industry 4.0 & IoT (MetroInd)</span>.<span class="meta">Premio · 2026</span>', en: 'Best Paper Award — <span class="venue">IEEE International Workshop on Metrology for Industry 4.0 & IoT (MetroInd)</span>.<span class="meta">Award · 2026</span>' },
            '.entry:nth-child(2) > span:last-child': { it: 'A Bioinspired Distributed Optical Fiber Sensing Device for Wearable Thermomechanical Monitoring of Breast Tissue. <span class="venue">Sensors and Actuators Reports</span>.<span class="meta">In revisione · Preprint: <a href="URL-DEL-PREPRINT" class="accent-inline-link" target="_blank" rel="noopener">arXiv</a></span>', en: 'A Bioinspired Distributed Optical Fiber Sensing Device for Wearable Thermomechanical Monitoring of Breast Tissue. <span class="venue">Sensors and Actuators Reports</span>.<span class="meta">Under review · Preprint: <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7175167" class="accent-inline-link" target="_blank" rel="noopener">arXiv</a></span>' }
    },
    'contatti.html': {
