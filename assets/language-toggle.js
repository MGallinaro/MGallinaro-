...
(function () {
  ...
  var pages = {
    'index.html': {
      ...
      '#chi-sono h2': { it: 'Misure e Strumentazione Biomedica', en: 'Biomedical Measurements and Instrumentation' },
      ...
      '.bio-text p:nth-child(1)': { it: 'Sono un <strong>Research Collaborator</strong> italiano specializzato in <strong>misure e strumentazione biomedica</strong> con focus sul sensing in fibra ottica distribuita (DOFS). Dopo una laurea triennale in Ingegneria Medica e una tesi magistrale dedicata allo sviluppo di un dispositivo biomedico indossabile per il rilevamento di lesioni del tessuto mammario tramite l’uso delle DOFS, lavoro oggi su strumentazione biomedicale che usa la luce, invece dell’elettronica, per misurare pressione, deformazione e temperatura sul corpo.', en: 'I am an Italian <strong>Research Collaborator</strong> specialising in <strong>biomedical measurements and instrumentation</strong>, with a focus on distributed optical fiber sensing (DOFS). After a bachelor’s degree in Medical Engineering and a master’s thesis on the development of a wearable biomedical device for detecting breast tissue lesions using DOFS, I now work on biomedical instrumentation that uses light rather than electronics to measure pressure, strain, and temperature on the body.' },
