(function () {
  ...
  var pages = {
    'index.html': {
      ...
      '.bio-text p:nth-child(3)': { it: 'La tecnologia che applico più spesso è il sensing a fibra ottica distribuita (DOFS), che trasforma la fibra stessa in un sensore continuo. In passato ho svolto collaborazioni con <strong>ENEA Frascati</strong>.', en: 'The technology I apply most often is distributed optical fiber sensing (DOFS), which turns the fiber itself into a continuous sensor. In the past I have collaborated with <strong>ENEA Frascati</strong>.' },
