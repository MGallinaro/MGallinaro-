(function () {
  ...
  var pages = {
    ...
    'distributed-wearable-device.html': {
      ...
      '.page-head .dek': { it: 'Proof of concept di una patch anulare in silicone, pensata per essere integrata in un indumento di uso quotidiano e monitorare la superficie mammaria. Una sola fibra ottica, disposta a spirale di Archimede e interrogata via OFDR, fornisce 458 punti di misura distribuiti di forza e temperatura. La leggera compressione dell’indumento crea tra patch e tessuto un’interazione simile a una palpazione distribuita: una regione più rigida o più calda modifica localmente la deformazione e la temperatura trasmesse alla fibra, e il sistema la rileva come variazione del segnale in quel punto.', en: 'Proof of concept of an annular silicone patch designed to be integrated into an everyday garment and monitor the breast surface. A single optical fiber, arranged as an Archimedean spiral and interrogated via OFDR, provides 458 distributed force and temperature sensing sites. The gentle compression of the garment creates a palpation-like distributed interaction between patch and tissue: a stiffer or warmer region locally alters the strain and temperature transferred to the fiber, and the system detects it as a signal change at that point.' },
      '.project-figure figcaption': { it: 'Dall’ispirazione biologica alla mappatura delle alterazioni termomeccaniche. Fonte: preprint SSRN 7175167.', en: 'From biological inspiration to the mapping of thermomechanical alterations. Source: SSRN preprint 7175167.' },
      '#distributed-wearable-device > .eyebrow': { it: 'Scheda tecnica', en: 'Technical sheet' },
            '#distributed-wearable-device .spec-table tbody': { it: '<tr><th scope="row">Geometria</th><td>Anello Ø 130 mm, foro 35 mm, spessore 3 mm</td></tr><tr><th scope="row">Layout fibra</th><td>Spirale di Archimede, raggio interno 20 mm, passo 7,4 mm</td></tr><tr><th scope="row">Fibra</th><td>Monomodale, ~1,2 m a metà spessore</td></tr><tr><th scope="row">Matrice</th><td>Ecoflex 00-30</td></tr><tr><th scope="row">Interrogazione</th><td>OFDR · Luna ODiSI 6102 · gage pitch 2,6 mm · 80 Hz</td></tr><tr><th scope="row">Punti di misura</th><td>458</td></tr><tr><th scope="row">Sensibilità in forza</th><td>−0,71 GHz/N (media, 0–100 N)</td></tr><tr><th scope="row">Sensibilità in temperatura</th><td>−2,25 GHz/°C (media, 22–44 °C)</td></tr>', en: '<tr><th scope="row">Geometry</th><td>Ring Ø 130 mm, 35 mm opening, 3 mm thick</td></tr><tr><th scope="row">Fiber layout</th><td>Archimedean spiral, 20 mm inner radius, 7.4 mm pitch</td></tr><tr><th scope="row">Fiber</th><td>Single-mode, ~1.2 m at mid-plane</td></tr><tr><th scope="row">Matrix</th><td>Ecoflex 00-30</td></tr><tr><th scope="row">Interrogation</th><td>OFDR · Luna ODiSI 6102 · 2.6 mm gage pitch · 80 Hz</td></tr><tr><th scope="row">Sensing sites</th><td>458</td></tr><tr><th scope="row">Force sensitivity</th><td>−0.71 GHz/N (mean, 0–100 N)</td></tr><tr><th scope="row">Temperature sensitivity</th><td>−2.25 GHz/°C (mean, 22–44 °C)</td></tr>' },
