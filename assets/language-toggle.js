  ...
  var pages = {
    'index.html': {
      ...
      '#progetto-in-evidenza .tag': { it: 'In revisione', en: 'Under review' },
            '#progetto-in-evidenza .feature-body > p': { it: 'Una patch anulare in silicone indossabile per il monitoraggio della superficie mammaria, sviluppata durante il mio lavoro di tesi magistrale. Il layout della fibra si ispira alla tela di cattura del ragno <em>Araneus diadematus</em>, organizzata secondo una spirale di Archimede: una geometria che permette di coprire in modo efficiente una superficie bidimensionale con una struttura unidimensionale, come il filo di seta. Interrogata via OFDR, la fibra diventa una rete di 458 punti di misura in grado di localizzare variazioni di forza e temperatura. Il lavoro è stato sottoposto alla rivista <em>Sensors and Actuators Reports</em> ed è attualmente in fase di revisione.', en: 'A wearable annular silicone patch for breast surface monitoring, developed during my MSc thesis. The fiber layout is inspired by the capture web of the spider <em>Araneus diadematus</em>, arranged as an Archimedean spiral: a geometry that efficiently covers a two-dimensional surface with a one-dimensional structure, such as a silk thread. Interrogated via OFDR, the fiber becomes a network of 458 measuring points able to localize changes in force and temperature. The work has been submitted to <em>Sensors and Actuators Reports</em> and is currently under review.' },
    ...
    'distributed-wearable-device.html': {
      ...
      '.page-head .back-link': { it: '← Tutti i progetti', en: '← All projects' },
            '.page-head .dek': { it: 'Una patch anulare in silicone indossabile, pensata per il monitoraggio della superficie mammaria. Una fibra ottica disposta a spirale di Archimede viene interrogata via OFDR, creando 458 punti di misura distribuiti capaci di rilevare forza e temperatura in modo localizzato su tutta la superficie del dispositivo.', en: 'A wearable annular silicone patch designed to monitor the breast surface. An optical fiber arranged as an Archimedean spiral is interrogated via OFDR, creating 458 distributed sensing sites able to detect force and temperature locally across the device.' },
      '#distributed-wearable-device > .eyebrow': { it: 'Scheda tecnica', en: 'Technical sheet' },
      '#distributed-wearable-device .about-grid > div:first-child': { it: '<p>Il dispositivo è un proof of concept pensato per essere integrato in un indumento di uso quotidiano. La leggera compressione esercitata dall’indumento crea tra patch e tessuto un’interazione simile a una palpazione distribuita: una regione più rigida o più calda modifica localmente la deformazione e la temperatura trasmesse alla fibra, e l’interrogazione OFDR la rileva come variazione dello spectral shift in quel punto del percorso.</p>', en: '<p>The device is a proof of concept designed for integration into an everyday garment. The gentle compression exerted by the garment creates a palpation-like distributed interaction between patch and tissue: a stiffer or warmer region locally alters the strain and temperature transferred to the fiber, which OFDR interrogation detects as a spectral-shift change at that point along the path.</p>' },
      '#distributed-wearable-device .skills': { it: '<div class="item"><b>Geometria</b>Anello Ø 130 mm, foro 35 mm, spessore 3 mm</div><div class="item"><b>Layout fibra</b>Spirale di Archimede, raggio interno 20 mm, passo 7,4 mm</div><div class="item"><b>Fibra</b>Monomodale, ~1,2 m a metà spessore</div><div class="item"><b>Matrice</b>Ecoflex 00-30</div><div class="item"><b>Interrogazione</b>OFDR · Luna ODiSI 6102 · gage pitch 2,6 mm · 80 Hz</div><div class="item"><b>Punti di misura</b>458</div><div class="item"><b>Sensibilità in forza</b>−0,71 GHz/N (media, 0–100 N)</div><div class="item"><b>Sensibilità in temperatura</b>−2,25 GHz/°C (media, 22–44 °C)</div><div class="item"><b>Stato</b>In revisione</div>', en: '<div class="item"><b>Geometry</b>Ring Ø 130 mm, 35 mm opening, 3 mm thick</div><div class="item"><b>Fiber layout</b>Archimedean spiral, 20 mm inner radius, 7.4 mm pitch</div><div class="item"><b>Fiber</b>Single-mode, ~1.2 m at mid-plane</div><div class="item"><b>Matrix</b>Ecoflex 00-30</div><div class="item"><b>Interrogation</b>OFDR · Luna ODiSI 6102 · 2.6 mm gage pitch · 80 Hz</div><div class="item"><b>Sensing sites</b>458</div><div class="item"><b>Force sensitivity</b>−0.71 GHz/N (mean, 0–100 N)</div><div class="item"><b>Temperature sensitivity</b>−2.25 GHz/°C (mean, 22–44 °C)</div><div class="item"><b>Status</b>Under review</div>' },
      '#sfide-strategie > .eyebrow': { it: 'Sfide e strategie', en: 'Challenges and approach' },
      '#strategia-layout': { it: '<h3>Layout della fibra</h3><p>Con il DOFS è la fibra stessa a definire dove si misura: bisognava coprire una superficie 2D con un sensore 1D. La soluzione è una spirale di Archimede ispirata alla tela di <em>Araneus diadematus</em>. È un percorso continuo senza incroci, ha passo costante (quindi campionamento spaziale uniforme) e curvatura dolce, che evita le pieghe brusche a cui la fibra è sensibile. Permette anche di rimappare in modo semplice ogni punto di misura sulla superficie.</p>', en: '<h3>Fiber layout</h3><p>In DOFS the fiber itself defines where measurements are taken: the challenge was to cover a 2D surface with a 1D sensor. The solution is an Archimedean spiral inspired by the capture web of <em>Araneus diadematus</em>. It is a continuous path with no crossings, has a constant pitch (hence uniform spatial sampling) and a smooth curvature that avoids the sharp bends the fiber is sensitive to. It also makes it straightforward to remap each sensing site onto the surface.</p>' },
      '#strategia-matrice': { it: '<h3>Matrice e integrazione della fibra</h3><p>Serviva un materiale abbastanza morbido da adattarsi al corpo, che trasferisse deformazione e temperatura alla fibra e la proteggesse. Ho scelto l’Ecoflex 00-30, il più cedevole tra i siliconi disponibili in laboratorio, e ho posizionato la fibra a metà dei 3 mm di spessore. La patch è realizzata con una doppia colata in stampi PLA stampati in 3D: il primo strato contiene la scanalatura a spirale che guida la fibra, il secondo la ingloba.</p>', en: '<h3>Matrix and fiber integration</h3><p>The material had to be soft enough to conform to the body while transferring strain and temperature to the fiber and protecting it. I chose Ecoflex 00-30, the most compliant silicone available in the lab, and placed the fiber at the mid-plane of the 3 mm thickness. The patch is made by two-step casting in 3D-printed PLA molds: the first layer contains the spiral groove that guides the fiber, the second one embeds it.</p>' },
      '#strategia-caratterizzazione': { it: '<h3>Caratterizzazione in condizioni realistiche</h3><p>Per misurare la risposta in forza la patch è stata compressa tra un phantom che simula il tessuto (Ecoflex GEL 2) e uno strato che simula l’indumento (DragonSkin 20), fino a 100 N. Con 458 punti non basta una curva di taratura unica: ho stimato la sensibilità di ogni punto, che risulta più alta all’esterno della spirale e diminuisce verso l’interno. La temperatura è stata caratterizzata in camera climatica tra 22 e 44 °C.</p>', en: '<h3>Characterization under realistic conditions</h3><p>To measure the force response, the patch was compressed up to 100 N between a tissue-mimicking phantom (Ecoflex GEL 2) and a garment-mimicking layer (DragonSkin 20). With 458 sensing sites a single calibration curve is not enough: I estimated the sensitivity of each site, which is higher in the outer part of the spiral and decreases toward the inner turns. Temperature was characterized in a climatic chamber between 22 and 44 °C.</p>' },
      '#strategia-localizzazione': { it: '<h3>Dalla risposta grezza alla localizzazione</h3><p>Nei test su phantom ho convertito la risposta di ogni punto in forza (o temperatura) equivalente usando la sua sensibilità locale. Per la parte meccanica ho usato un approccio differenziale: alla forza equivalente di ogni punto ho sottratto la forza applicata, misurata dalla cella di carico. Poi ho rimosso l’andamento spaziale lento, sottraendo il trend a media mobile lungo la fibra, così da far emergere solo le deviazioni locali dalla risposta uniforme attesa. Le mappe ottenute hanno evidenziato zone coerenti con la posizione di un’inclusione rigida in PLA di 15 mm in quattro posizioni diverse. Nei test termici hanno localizzato cavità riempite d’acqua calda, anche in configurazioni doppie e ramificate.</p>', en: '<h3>From raw response to localization</h3><p>In the phantom tests I converted the response of each sensing site into an equivalent force (or temperature) using its local sensitivity. For the mechanical tests I used a differential approach: the force applied by the load cell was subtracted from the equivalent force of each site. I then removed the slowly varying spatial component by subtracting a moving-average trend along the fiber, so that only local deviations from the expected uniform response remained. The resulting maps highlighted regions consistent with the position of a 15 mm rigid PLA inclusion placed in four different positions. In the thermal tests they localized cavities filled with hot water, including double and branched configurations.</p>' },
