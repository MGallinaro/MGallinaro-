(function () {
  ...
  var pages = {
    'index.html': {
      ...
      '.bio-text p:nth-child(4)': { it: 'Sono laureato in Ingegneria Biomedica presso l’Università Campus Bio-Medico di Roma (laurea triennale in Ingegneria Medica a Tor Vergata). Nel 2026 ho ricevuto il <strong>Best Paper Award</strong> a IEEE MetroInd per il dispositivo indossabile distribuito che trovi <a href="#progetto-in-evidenza" class="accent-inline-link">qui sotto</a>.', en: 'I hold a degree in Biomedical Engineering from Università Campus Bio-Medico di Roma (bachelor’s in Medical Engineering from Tor Vergata). In 2026 I received the <strong>Best Paper Award</strong> at IEEE MetroInd for the distributed wearable device described <a href="#progetto-in-evidenza" class="accent-inline-link">below</a>.' },
      ...
      '#progetto-in-evidenza .tag': { it: 'In revisione', en: 'Under review' },
            '#progetto-in-evidenza .feature-body > p': { it: 'Una patch anulare in silicone indossabile per il monitoraggio della superficie mammaria, sviluppata durante il mio lavoro di tesi magistrale. Il layout della fibra si ispira alla tela di cattura del ragno <em>Araneus diadematus</em>, organizzata secondo una spirale di Archimede: una geometria che permette di coprire in modo efficiente una superficie bidimensionale con una struttura unidimensionale, come il filo di seta, e di distribuire uniformemente le tensioni sulla tela. Interrogata via OFDR, la fibra diventa una rete di centinaia di punti di misura in grado di localizzare variazioni di forza e temperatura. Il lavoro ha vinto il Best Paper Award a IEEE MetroInd 2026.', en: 'A wearable annular silicone patch for breast surface monitoring, developed during my MSc thesis. The fiber layout is inspired by the capture web of the spider <em>Araneus diadematus</em>, arranged as an Archimedean spiral: a geometry that efficiently covers a two-dimensional surface with a one-dimensional structure, such as a silk thread, while distributing tension evenly across the web. Interrogated via OFDR, the fiber becomes a network of hundreds of measuring points able to localize changes in force and temperature. The work received the Best Paper Award at IEEE MetroInd 2026.' },
