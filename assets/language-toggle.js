  ...
  var pages = {
    ...
    'distributed-wearable-device.html': {
      ...
      '#sfide-strategie > .eyebrow': { it: 'Sfide e strategie', en: 'Challenges and approach' },
            '#strategia-matrice': { it: '<h3>Matrice siliconica</h3><p>Come matrice ho scelto l’Ecoflex 00-30, uno dei siliconi più cedevoli disponibili (durezza Shore 00-30). Il motivo è meccanico. Uno strato rigido si comporta come una piastra: ridistribuisce un carico locale su un’area ampia e attenua le deformazioni prima che raggiungano la fibra. Una matrice molto cedevole, invece, segue la superficie del tessuto e mantiene il segnale localizzato. È una condizione necessaria per rilevare disomogeneità più rigide, come i noduli, simulati nei phantom con inclusioni sferiche in PLA.</p>', en: '<h3>Silicone matrix</h3><p>I chose Ecoflex 00-30 as the matrix, one of the most compliant silicones available (Shore 00-30). The reason is mechanical. A stiff layer behaves like a plate: it spreads a local load over a wide area and smooths out deformations before they reach the fiber. A highly compliant matrix instead follows the tissue surface and keeps the signal localized. This is essential for detecting stiffer inhomogeneities such as nodules, simulated in the phantoms with spherical PLA inclusions.</p>' },
