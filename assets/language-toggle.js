  ...
  var pages = {
    'index.html': {
      ...
      '.skills-col:nth-child(1) .skills-list': {
            it: '<li><strong>Programmazione e analisi dati:</strong> MATLAB, Python, Simulink</li><li><strong>Simulazione e progettazione:</strong> Fusion 360, Eagle</li><li><strong>Metodi sperimentali:</strong> sistemi di interrogazione in fibra ottica, prove meccaniche (Instron), caratterizzazione termica e meccanica, test su phantom</li><li><strong>Tecnologie di sensing:</strong> FBG, DOFS</li>',
            en: '<li><strong>Programming &amp; Data Analysis:</strong> MATLAB, Python, Simulink</li><li><strong>Simulation &amp; Design:</strong> Fusion 360, Eagle</li><li><strong>Experimental Methods:</strong> optical fiber interrogation systems, mechanical testing (Instron), thermal/mechanical characterization, phantom-based testing</li><li><strong>Sensing Technologies:</strong> FBG, DOFS</li>'
          },
