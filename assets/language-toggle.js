  ...
  var pages = {
    ...
    'distributed-wearable-device.html': {
      ...
      '#sfide-strategie > .eyebrow': { it: 'Sfide e strategie', en: 'Challenges and approach' },
            '#strategia-matrice': { it: '<h3>Matrice siliconica</h3><p>Come matrice ho scelto l’Ecoflex 00-30 (durezza Shore 00-30), il silicone più cedevole tra quelli disponibili in laboratorio. Il motivo è meccanico. Uno strato rigido si comporta come una piastra: ridistribuisce un carico locale su un’area più ampia e attenua le deformazioni prima che raggiungano la fibra, tanto più quanto è rigido e spesso. Uno strato sottile e molto cedevole, invece, segue la superficie del tessuto e mantiene il segnale localizzato. È una caratteristica che favorisce il rilevamento di disomogeneità più rigide, come i noduli, simulati nei phantom con inclusioni sferiche in PLA.</p>', en: '<h3>Silicone matrix</h3><p>I chose Ecoflex 00-30 (Shore 00-30) as the matrix, the most compliant silicone available in the lab. The reason is mechanical. A stiff layer behaves like a plate: it spreads a local load over a wider area and smooths out deformations before they reach the fiber, the more so the stiffer and thicker it is. A thin, highly compliant layer instead follows the tissue surface and keeps the signal localized. This favours the detection of stiffer inhomogeneities such as nodules, simulated in the phantoms with spherical PLA inclusions.</p>' },
